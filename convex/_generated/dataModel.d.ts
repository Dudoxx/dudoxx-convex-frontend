 ...
 *
 * Convex documents are uniquely identified by their `Id`, which is accessible on the `_id` field.
 *
 * To learn more, see [Document IDs](https://docs.convex.dev/using/document-ids).
 *
 * @typeParam TableName - A string literal type of the table name (like "users").
 */
